...
function Calendar(element, options, eventSources) {
	...
	function gotoDate(year, month, dateOfMonth) {
		var date1;
	   var tt = $("#gotoDate1").val();
	   date1 = new Date(tt);
	    if (date1!='Invalid Date') date = new Date(tt);
		 else { date = new Date(); }
...
function htmlEscape(s) {
	return s.replace(/&/g, '&amp;')
		...
		.replace(/"/g, '&quot;')
		.replace(/\n/g, '<br />')
		.replace(/\k/g,'<img src="images/tron2.png">')
		.replace(/\t/g,'<img src="images/tron1.png">');
}
function htmlEscape1(s) {
	return s;
}
...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) {
		...
		if (showNumbers) {
			html += "<div class='fc-day-number'><a href='./TB020_予定入力.html'></li>" + date.getDate() + "</a></div>";
		}
...
function AgendaEventRenderer() {
	...
	function slotSegHtml(event, seg) {
		...
		html +=
			...
			"</div>" +
			"<div class='fc-event-title'>  <img src='images/tron1.png'></img>" +htmlEscape(event.title) +
			"</div>" +
			"</div>" +
...
function DayEventRenderer() {
	...
	function buildHTMLForSegment(segment) {
		...
		html +=
			" <span class='fc-event-title'>" + htmlEscape1(event.title) + "</span>" +
			"</div>";
