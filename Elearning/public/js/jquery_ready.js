hs.graphicsDir = 'http://www.tienganh123.com/highslide/graphics/';
...
$(document).ready(function() {
    ...
    //Back Top
    $("#tops").hover(function() {
        $(this).css("background", "url(http://data.tienganh123.com/images/v2/home/img_homepage.png) no-repeat scroll -220px -455px transparent")
    }, function() {
        $(this).css("background", "url(http://data.tienganh123.com/images/v2/home/img_homepage.png) no-repeat scroll -170px -455px transparent")
    })
    ...
    $(".actiHD").live("click", function() {
        if (confirm("Duyệt câu hỏi này được phép hiển thị ra bên ngoài ?")) {
            ...
            $.post(base_urlroot + "mod/hoidapnhanh.php", params, function() {
                $('.actiHD[rel=' + IdQs + ']').html('&nbsp;<img src="http://data.tienganh123.com/images/v2/home/accept-icon.png">')
            })
        }
        else
            return false;
    ...
    $("a#icon-fb").click(function() {
        var url = 'http://www.tienganh123.com/fb';
        var _width = 900;
        var Xpos = ((screen.availWidth - _width) / 2);
        var _height = 500;
        var Ypos = ((screen.availHeight - _height) / 2);
