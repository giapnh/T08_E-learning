...
class  Message{
	...
	public static $M002 = "パースワードがない";
	public static $M003 = "ユーザネームとパースワードが会っていない";
	public static $M004 ="この IP がロックさせている。LOGIN_FAIL_LOCK_TIME 時後に戻してください";
	public static $M005  ="このユーザが削除しました。システムの管理者に連絡してください";
	public static $M006  ="ユーザネームが無効";
	public static $M007  ="パースワードが無効";
	public static $M008  ="パースワード確認とパースワードが間違う";
	public static $M009  ="名前が無効";
	public static $M010 ="誕生日が無効";
	...
	public static $M017  ="新しいパースワードが無効";
	public static $M018  ="新しいパースワード確認が無効";
	public static $M019  ="パースワードが正しくない";
	public static $M020  ="授業のタイトルが無効";
	public static $M021  ="タグが無効";
	public static $M022  ="ファイル名が無効";
	public static $M023  ="ファイルが無効";
	public static $M024  ="ファイルが存在していない";
	public static $M025  ="申し訳ありません、ファイルがなくなりました";
	public static $M026  ="登録完成しました";
	public static $M027  ="IP アドレスが無効";
	public static $M028  ="本当にパースワードをリセットしますか";
	public static $M029  ="本当に秘密質問をリセットしますか";
	public static $M030  ="本当にユーザを削除しますか";
